...
Unlike humans, who acquire knowledge from only a small amount of experience, today’s large models rely on massive data. His research aims to bridge this gap by seeking deep learning algorithms that enable models to understand the world from limited exposure.

- **Neural architectures aligned with human cognition** \
To emulate the sophistication of human intelligence, neural architectures should be deeply grounded in human cognitive systems. His research explores how cognitive principles inform the design of neural architectures toward genuine intelligence.
